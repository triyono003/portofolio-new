  ...
  <section id="home"class="pt-10">
    <div class="container mx-auto">
      <div class="flex flex-wrap">
        ...
        <a href=""class="bg-primary text-white font-semibold rounded-full px-4 py-2 hover:shadow-lg hover:bg-teal-400 transition-duration-300 ease-in-out">Contact Me</a>
        </div>
     ...
     <div class="flex flex-wrap">
       ...
       <div class="w-full px-4 mt-10 md:w-1/2">
         ...
         <div class="flex items-center">
           {{-- Instagram --}} 
          <a href="#"target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:bg-primary transition-duration-300 ease-in-out text-primary hover:text-white">
